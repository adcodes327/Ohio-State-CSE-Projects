...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
         ...
         */
        overlap = str1.length() - overlap; // finding index of overlap
        str1 = str1.substring(0, overlap);
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        while (strSet.size() > 0) {
            ...
            // if strings are not substrings
            if ((str.indexOf(s) < 0) || s.equals(str)) {
                temp.add(s);
            }
            if (s.indexOf(str) > -1) {
                ++substring; // number of substrings found
            }
        }
        // no substrings found
        if (substring == 0) {
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        while (!input.atEOS()) {
            ...
            addToSetAvoidingSubstrings(lines, text);
        }
        return lines;
    }
    ...
    public static void printWithLineSeparators(String text, SimpleWriter out) {
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            if (indexChar == '~') { // character is a separator
                out.println();
            } else {
                out.print(indexChar);
            }
